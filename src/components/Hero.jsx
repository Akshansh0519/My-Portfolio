...
import heroVideo from '../assets/hero video/akshansh-hero.mp4';
  ...
  const toggleVideo = (e) => {
    ...
    if (videoRef.current) {
      if (videoRef.current.paused) {
        // Guarantee video starts exactly from the 0th second (0.0000s)
  ...
  return (
    <section id="home" className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full md:-translate-y-17 md:-translate-x-25 transition-transform duration-300">
          ...
          >
            ...
            {/* Resume SDE Download Button */}
            <a 
              href={heroContent.ctaResumeSde.href}
              id="hero-resume-sde"
              download
            ...
            >
              ...
              {heroContent.ctaResumeSde.text}
            </a>

            {/* Resume AI/ML Download Button */}
            <a 
