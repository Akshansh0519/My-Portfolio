...
const Contact = () => {
  ...
  return (
    <section ref={ref} id="contact" className="bg-[#0a0a0a] w-full min-h-screen relative overflow-hidden flex items-end pt-32 pb-0 md:pb-0 border-t border-gray-900">
      ...
      <motion.div 
        style={{ y }}
        className="absolute top-0 left-0 w-full h-full flex flex-col justify-start items-center overflow-hidden pointer-events-none z-0 pt-6 md:pt-8"
      >
        <h1 
          className="text-[22vw] leading-[0.85] font-black text-white uppercase tracking-tighter select-none scale-y-[1.15] origin-top"
      ...
      <div className="relative z-10 w-full flex justify-end items-end">
        <div 
          data-aos="fade-up"
          className="bg-[#0d1117] border-t border-l border-cyan-500/20 w-full md:w-[85%] lg:w-[75%] p-8 md:p-16 text-white flex flex-col justify-between"
        >
          <div className="flex flex-col sm:flex-row justify-between items-start gap-8 mb-12">
            ...
            <a 
              ...
              className="flex items-center gap-2 text-xs font-black uppercase tracking-wider bg-white/5 hover:bg-cyan-500/20 hover:text-cyan-400 border border-white/10 hover:border-cyan-500/40 px-4 py-2 rounded-full transition-all duration-300"
            >
                  ...
                  <button 
                    ...
                    className={`px-8 py-3 rounded-full border border-white/40 text-white font-bold flex items-center justify-center gap-3 transition-all duration-300 group whitespace-nowrap self-start sm:self-auto ${
                      status === 'sending' 
                        ...
                        : status === 'error'
                        ? 'bg-cyan-900/50 border-cyan-700 text-cyan-100'
